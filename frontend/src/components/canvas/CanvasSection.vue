<template>
  <q-card class="container-card" :class="info.class">
    <q-card-section :class="colorStore.darkMode ? 'dark-top-q-card' : 'top-q-card'">
    ...
    <q-list separator>
      <q-card-section class="q-pa-lg text-italic" v-show="(canvas[canvasName][info.sectionKey].size === 0 )|| Object.keys(canvas[canvasName][info.sectionKey]).length === 0 && canvas[canvasName][info.sectionKey].constructor === Object">{{info.instructions}}</q-card-section>
      <q-item
