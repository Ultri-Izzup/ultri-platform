    ...
    <div class="row" :style="Screen.lt.md ? 'width: 100%' : 'width: 80%'">
      <div :class="Screen.lt.md ?  'col-12 q-pa-sm' : 'col-6 q-pa-lg'">
        <q-card class="q-pa-sm fit">
          <q-card-section>
             <div  class="text-h4 text-bold text-primary q-pb-sm">{{ $t('canava.home.getStarted', 'Get Started') }}</div>
           <q-separator></q-separator>
           <p class="text-h6 text-shd-p-90 q-pa-lg">
            Canava is another free business tool from Ultri. It was born from our own internal needs to manage and create many canvases.
           <br /><br />
            Create a custom canvas using one of our many templates, or start from scratch.
           </p>
           <p class="text-center">
            <q-btn label="Custom Canvas" color="primary" clickable v-ripple :to="{ name: 'canavaDesigner'}"></q-btn>
           </p>
          </q-card-section>
        </q-card>
      </div>
      <div :class="Screen.lt.md ? 'col-12 q-pa-sm' : 'col-6 q-pa-lg'">
        <q-card  class="q-pa-sm fit">
          <q-card-section>
           <div  class="text-h4 text-bold text-primary q-pb-sm">{{ $t('canava.home.benfits', 'Free Canava Benefits') }}</div>
           <q-separator></q-separator>
