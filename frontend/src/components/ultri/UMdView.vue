...
const props = defineProps({
  ...
  css: {
    type: Object,
    default: () => { return {h1: 'font-size:2.1em; line-height: 1.35; color: #455A64',
...
const styledMarkdown = ref(markdown.render(props.modelValue));

colorStore.$subscribe((mutation, state) => {

  if(state.darkMode){
    const newCSS = {h1: 'font-size:2.1em; line-height: 1.35; color: #FFFFFF',
    ...
    const newCSS = {h1: 'font-size:2.1em; line-height: 1.35; color: #455A64',
                              h2:'font-size:1.9em; line-height: 1.37; color: #455A64',
                              h3: 'font-size:1.7em; line-height: 1.40; color: #455A64',
                              h4:'font-size:1.5em; line-height: 1.45; color: #455A64',
                              h5: 'font-size:1.3em; line-height: 1.45; color: #455A64',
